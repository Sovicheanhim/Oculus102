...
public class Bezier : MonoBehaviour {
    ...
    void DrawCurve() {
        ...
        //All, here's a quick way to extend how much your line continues rendering the curve. Basically, "t" (the variable seen in the jasondavies link) stops at 1 with the current code. Here's a quick fix to double that length(or use something higher than 2 if you want to extend it further). You'll find this in the DrawCurve method in the Bezier script.
        ...
        //    lineRenderer.positionCount = i + 1;
            ...
            if (CheckColliderIntersection(prevPosition, nextPosition)) { // If the segment intersects a surface, draw the point and return.
                ...
                // This is to continue drawing the pointer if it doesn't hit the ground or object unless it hits one
